        ...
        <table className='styled-table'>
          <thead>
            <tr>
              ...
              <th style={{textAlign:'center'}}>Manufacture</th>
              ...
              {data.map((item,index)=>{
                return(
                  <tr key={index}>
                    ...
                    <td>
                      <Link to={`/UpdateAirplane/${item.plane_id}`}>
                        <button className='btn btn-edit'>Edit</button>
                      </Link>
                        <button className='btn btn-delete' onClick={()=> delAirplane(item.plane_id)}>Delete</button>
                      <Link to={`/ViewAirplane/${item.plane_id}`}>
