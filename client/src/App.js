...
import CrewAssignmentsList from './components/Pages/CrewAssignmentsList';
import EditCrewAssignment from './components/Pages/EditCrewAssignment';
...
function App() {
  return (
    <BrowserRouter>
        ...
        <Switch>
        <Route exact path="/crew-assignments" component={CrewAssignmentsList} />
        <Route exact path="/edit-crew/:id" component={EditCrewAssignment} />
        <Route exact path="/edit-crew" component={EditCrewAssignment} />
        <Route exact path="/add-crew" component={AddCrew} />
